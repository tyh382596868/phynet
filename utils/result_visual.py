...
if __name__=='__main__':
    num=13200
    name = f'sam_ref_dropout_full_0.01'#一、生成的文件存放路径，最好与二里一致1536_1536_sam_pi_01_prop_pi/2024-02-21-21-53
    
    # 二、读取的ref或Sam路径
    ref_path = f'/mnt/data/optimal/tangyuhang/workspace/iopen/ai4optical/phynet_git/result/net_model_Dropout_full/net_model_Dropout_full_last_p/1536_1536_ref_pi_01_prop_pi/2024-03-06-20-38/img_txt_folder/0.01/132000_pred.txt'

...
if __name__=='__main__':
    ...
    # 二、读取的ref或Sam路径
    ref_path = f'/mnt/data/optimal/tangyuhang/workspace/iopen/ai4optical/phynet_git/result/1536_1536_sam_pi_01_prop_pi_mask/2024-02-22-20-27/img_txt_folder/1000_pred.txt'
    ...
    diff = (sam - ref)
    save_path = './sam1000_sam79500.png'

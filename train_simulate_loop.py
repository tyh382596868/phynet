...
def train_simulate(para,loop):

    pha_gt,amp_gt,mask_gt,speckle_gt  = getData(para,loop)
...
if __name__=="__main__":
    ...
    for loop in para.loops:
        print(f'loop:{loop}')
        train_simulate(para,loop)

        ...
        if os.path.exists(folder):
            ...
            for filename in os.listdir(folder):
                ...
                if filename.endswith('.txt'):
                    ...
                    # 1.dataset
                    print(f'H W:{cropped_amp.shape}')
                    cropped_amp = torch.tensor(cropped_amp).to(device).unsqueeze(0)
                    train_data = mydataset(cropped_amp)
                    print(f'C H W:{cropped_amp.shape}')

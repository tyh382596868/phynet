...
class conv_block(torch.nn.Module):
    def __init__(self,in_channels,out_channels,drop=0.01):
...
class net_model_Dropout_full_all_p(torch.nn.Module):
    
    def __init__(self,drop=0.01):
        
        super(net_model_Dropout_full_all_p, self).__init__()
        ...
        self.layer_01 = torch.nn.Sequential(
            ...
            conv_block(in_channels=32,out_channels=32,drop=drop)
            )
        ...
        self.layer_02 = conv_block(in_channels=32,out_channels=64,drop=drop)
        ...
        self.layer_03 = conv_block(in_channels=64,out_channels=128,drop=drop)
        ...
        self.layer_04 = conv_block(in_channels=128,out_channels=256,drop=drop)
        ...
        self.layer_05 = conv_block(in_channels=256,out_channels=512,drop=drop)
        ...
        self.layer_06_02 = conv_block(in_channels=512,out_channels=256,drop=drop)
        ...
        self.layer_07_02 = conv_block(in_channels=256,out_channels=128,drop=drop)
        ...
        self.layer_08_02 = conv_block(in_channels=128,out_channels=64,drop=drop)
        ...
        self.layer_09_02 = conv_block(in_channels=64,out_channels=32,drop=drop)
...
if __name__=='__main__':
    ...
    net = net_model_Dropout_full_all_p(drop=0.5)
    y = net(x)
    print(y.shape)
    print(net)

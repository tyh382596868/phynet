...
class my_wraptopi(torch.nn.Module):
...
class net_model_Dropout_full_my_wraptopi(torch.nn.Module):
    
    def __init__(self,drop=0.1):
        
        super(net_model_Dropout_full_my_wraptopi, self).__init__()

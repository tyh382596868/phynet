...
class res_block(torch.nn.Module):
    def __init__(self,in_channels,out_channels):
        ...
        self.shortcut = torch.nn.Conv2d(in_channels,out_channels,(1,1),stride=(1,1),padding=0)

    def forward(self,input):

        indentity = input
        output = self.layer(input)
        output += self.shortcut(indentity)
...
class net_model_res(torch.nn.Module):
    
    def __init__(self):
        
        super(net_model_res, self).__init__()
        ...
        self.layer_02 = res_block(in_channels=32,out_channels=64)
        ...
        self.layer_03 = res_block(in_channels=64,out_channels=128)
        ...
        self.layer_04 = res_block(in_channels=128,out_channels=256)
        ...
        self.layer_05 = res_block(in_channels=256,out_channels=512)
        ...
        self.layer_06_02 = res_block(in_channels=512,out_channels=256)
        ...
        self.layer_07_02 = res_block(in_channels=256,out_channels=128)
        ...
        self.layer_08_02 = res_block(in_channels=128,out_channels=64)
        ...
        self.layer_09_02 = res_block(in_channels=64,out_channels=32)
...
if __name__=='__main__':
    ...
    #         res_block(in_channels=32,out_channels=32)
    #         )
    net =  res_block(in_channels=1,out_channels=16)
    # net = net_model_depth()
    y = net(x)
    print(y.shape)
    print(net)

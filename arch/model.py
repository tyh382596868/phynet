...
if __name__ == '__main__':
    ...
    model2 = NestedUNet(in_ch=1, out_ch=1)
    # print(model2)
    input2 = torch.rand(1, 1, 256, 256)
    output2 = model2(input2)
    print(output2.shape)
    
    model3 = R2AttU_Net(in_ch=1, out_ch=1)
    # print(model3)
    input3 = torch.rand(1, 1, 256, 256)
    output3 = model3(input3)              
    print(output3.shape)
# U_Net,R2U_Net,AttU_Net,R2AttU_Net,NestedUNet    

    model4 = R2U_Net(img_ch=1, output_ch=1)
    # print(model4)
    input4 = torch.rand(1, 1, 256, 256)
    output4 = model4(input4)          
    print(output4.shape)
    
    model5 = AttU_Net(img_ch=1, output_ch=1)
    # print(model5)
    input5 = torch.rand(1, 1, 256, 256)
    output5 = model5(input5)          
    print(output5.shape)
    
    model6 = R2AttU_Net(in_ch=1, out_ch=1)
    # print(model6)
    input6 = torch.rand(1, 1, 256, 256)
    output6 = model6(input6)        
    print(output6.shape)
    
    model7 = NestedUNet(in_ch=1, out_ch=1)
    # print(model7)
    input7 = torch.rand(1, 1, 256, 256)
    output7 = model7(input7)          
    print(output7.shape)

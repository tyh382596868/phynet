...
if __name__=='__main__':
    ...
    ref_path = '/mnt/data/optimal/tangyuhang/workspace/iopen/ai4optical/phynet_git/result/1536_1536_ref_pi_prop_pi/2024-02-01-16-26/img_txt_folder/1000_pred.txt'
    sam_path=  '/mnt/data/optimal/tangyuhang/workspace/iopen/ai4optical/phynet_git/result/1536_1536_sam_pi_prop_pi/2024-02-01-15-44/img_txt_folder/1000_pred.txt'
    ref = my_readtxt(ref_path)
    sam = my_readtxt(sam_path)
    diff = (sam - ref + 2.05)%(np.pi)

    import scipy.signal as signal
    diff = signal.medfilt(diff,(11,11)) #二维中值滤波
    save_path = './net_predsam_predref1.png'

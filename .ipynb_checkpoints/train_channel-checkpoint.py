...
if __name__ == "__main__":
    ...
    basechannels = [16,32,48,64,96,128,192,256,512,768,1024]
    ...
    for basechannel in tqdm(basechannels):
        print(type(basechannel))
        print(f'sam_{basechannel}')

        
        tb_folder = f'{result_folder}/tb_folder/{basechannel}'

        weight_folder = f"{result_folder}/weight_folder/{basechannel}"
        img_txt_folder = f'{result_folder}/img_txt_folder/{basechannel}'
        ...
        net  =  modelnet(basechannel).to(device)
